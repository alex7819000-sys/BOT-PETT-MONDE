...
const app = express();
// Render assigne son propre port via process.env.PORT — il FAUT l'utiliser en priorité,
// sinon Render route le trafic vers un port que le serveur n'écoute jamais et tout
// échoue silencieusement. DASHBOARD_PORT reste utilisable pour du dev en local.
