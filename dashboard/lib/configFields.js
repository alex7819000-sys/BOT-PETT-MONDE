...
const GENERAL_GROUPS = [
  {
    ...
    fields: [
      ...
      { key: 'welcomeChannelId', label: 'Bienvenue (message court)', type: 'channel' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'singeRoleId', label: 'Rôle Singe (punition counting)', type: 'role' },
      { key: 'podiumTextChampionRoleId', label: 'Champion Textuel du jour', type: 'role' },
      { key: 'podiumVoiceChampionRoleId', label: 'Champion Vocal du jour', type: 'role' },
...
const OTHER_SYSTEMS_GROUPS = [
  {
    title: 'Quêtes & Défis H24',
    icon: '📋',
    fields: [
      { key: 'questsChannelId', label: 'Salon Quêtes (panneau permanent)', type: 'channel' },
      { key: 'questsEnabled', label: 'Génération automatique des quêtes', type: 'boolean' },
      { key: 'bonusDurationHours', label: 'Durée des bonus XP (heures, défaut: 24)', type: 'number' },
      { key: 'bonusRole25Id', label: 'Rôle bonus ⭐ +25% XP', type: 'role' },
      { key: 'bonusRole50Id', label: 'Rôle bonus 🌟 +50% XP', type: 'role' },
      { key: 'bonusRole100Id', label: 'Rôle bonus 💫 +100% XP', type: 'role' },
      { key: 'mudaeChannelId', label: 'Salon Mudae (pour $dk kakera)', type: 'channel' },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: 'trophyChannelId', label: 'Trophy Room (podium, roi du jour, récompenses)', type: 'channel' },
