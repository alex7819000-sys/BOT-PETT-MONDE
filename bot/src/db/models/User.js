...
const schema = new mongoose.Schema({
  ...
  boostEndedAt: { type: Date, default: null },            // date à laquelle le boost s'est arrêté (null si jamais boosté ou boost actif)
  lastExBoosterReminderAt: { type: Date, default: null },  // dernier MP de relance envoyé
