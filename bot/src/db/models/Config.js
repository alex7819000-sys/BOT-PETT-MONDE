...
const schema = new mongoose.Schema({
  ...
  debatChannelId: String, inviteChannelId: String,
  ...
  aiChatChannelId: String,             // si défini, le bot ne répond QUE dans ce salon (sinon, partout)
  ...
  chatReviveChannelId: String,     // salon où poster le ping "chat revive"
  chatReviveRoleId: String,        // rôle pingé à chaque nouvelle arrivée de membre
  chatReviveMinutes: { type: Number, default: 90 }, // (réservé usage futur : inactivité avant ping)
  kingOfHeraRoleId: String,        // trophée hebdo unique — donné au meilleur XP de la semaine, retiré au reset dimanche
