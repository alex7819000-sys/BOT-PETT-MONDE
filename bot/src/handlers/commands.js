  ...
  try {
    switch (cmd) {
      ...
      case '7777': {
        ...
        if (sub === 'setup') {
          return h7777.handleSetup(interaction);
        }
        // Vérification du salon configuré (sauf pour setup/collection/leaderboard)
        if (sub === 'roll') {
        ...
        if (sub === 'collection') {
          return h7777.handleCollection(interaction);
        }
        if (sub === 'leaderboard') {
          return h7777.handleLeaderboard(interaction);
        }
        if (sub === 'semaine') {
          return h7777.handleWeekly(interaction);
        }
        break;
      }
