...
async function handle(interaction) {
  ...
  if (sub === 'equipe') {
    ...
    const row = new ActionRowBuilder().addComponents(
      new ButtonBuilder().setCustomId('war:join:dog').setLabel('🐶 Team Chien').setStyle(ButtonStyle.Primary),
      new ButtonBuilder().setCustomId('war:join:cat').setLabel('🐱 Team Chat').setStyle(ButtonStyle.Success),
    );
