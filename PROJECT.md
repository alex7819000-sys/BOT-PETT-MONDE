...
> Dernière mise à jour : v92 (août 2026)

---

## Version actuelle : v92

Base : v91 → v90 → v89 → v88 → v87 → v86 → v85 → v84 → v83 → v82 → v81 → v80 → v79 → v78 → v77 → v76 → v75 → v74 → v73 → v72 → v71 → v70 → v69 → v68 → v63 → v62 → v61 → v60 → v59 → v56 (corrigé depuis v55 → v54 → v43 → v20)
