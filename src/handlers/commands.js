...
function buildCommands() {
  return [
    ...
    // /defis
    new SlashCommandBuilder().setName('defis').setDescription('Défis quotidiens + King Challenge')
      .addSubcommand(s => s.setName('liste').setDescription('Voir tous les défis actifs'))
      .addSubcommand(s => s.setName('quotidien').setDescription('Lancer un défi quotidien maintenant (Admin)'))
      .addSubcommand(s => s.setName('king').setDescription('👑 Lancer le King Challenge maintenant (Admin)'))
      .addSubcommand(s => s.setName('nioui').setDescription('🎯 Lancer le défi Ni Oui Ni Non (Admin)'))
      .addSubcommand(s => s.setName('creer').setDescription('Créer un défi custom (Admin)')
        .addStringOption(o => o.setName('type').setDescription('Type de défi').setRequired(false)
          .addChoices(
            { name: '💬 Messages',    value: 'messages' },
            { name: '🚀 Bumps',       value: 'bumps' },
            { name: '📨 Invites',     value: 'invites' },
            { name: '🎯 Ni Oui Ni Non', value: 'nioui' },
        ...
        .addIntegerOption(o => o.setName('xp').setDescription('XP à gagner').setRequired(false))
        .addIntegerOption(o => o.setName('kakera').setDescription('Kakera Mudae à gagner').setRequired(false))
        .addBooleanOption(o => o.setName('king').setDescription('Marquer comme King Challenge').setRequired(false))
