  ...
  if (sub === 'init') {
    ...
    try {
      ...
      const rolesDef = [
        ...
        // ── Rôles couleur (choix membre via DM) ─────────────────────────
        { name: '🔴 | Rouge',       color: 0xE74C3C, field: null, colorRole: true, emoji: '🔴' },
        { name: '🟠 | Orange',      color: 0xE67E22, field: null, colorRole: true, emoji: '🟠' },
        { name: '🟡 | Jaune',       color: 0xF1C40F, field: null, colorRole: true, emoji: '🟡' },
        { name: '🟢 | Vert',        color: 0x2ECC71, field: null, colorRole: true, emoji: '🟢' },
        { name: '🔵 | Bleu',        color: 0x3498DB, field: null, colorRole: true, emoji: '🔵' },
        { name: '🟣 | Violet',      color: 0x9B59B6, field: null, colorRole: true, emoji: '🟣' },
        { name: '🩷 | Rose',        color: 0xFF69B4, field: null, colorRole: true, emoji: '🩷' },
        { name: '🩵 | Cyan',        color: 0x1ABC9C, field: null, colorRole: true, emoji: '🩵' },
        { name: '🫐 | Indigo',      color: 0x5865F2, field: null, colorRole: true, emoji: '🫐' },
        { name: '🟤 | Marron',      color: 0xA0522D, field: null, colorRole: true, emoji: '🟤' },
        { name: '⚪ | Blanc',       color: 0xF2F3F5, field: null, colorRole: true, emoji: '⚪' },
        { name: '🖤 | Noir',        color: 0x2C2F33, field: null, colorRole: true, emoji: '🖤' },
      ];
      const updates = {};
