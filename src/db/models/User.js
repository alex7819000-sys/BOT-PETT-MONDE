...
const userSchema = new Schema({
  ...
  // Welcome Boost — x2 XP pendant 7 jours après l'arrivée
  welcomeBoostUntil: { type: Date, default: null },
  // Giveaway tickets
  giveawayTickets: { type: Number, default: 0 },
  // Bonus première visite salon de jeu par jour : { 'YYYY-MM-DD': [channelId, ...] }
  dailySalonVisits: { type: Map, of: [String], default: {} },
}, {
  timestamps: true,
