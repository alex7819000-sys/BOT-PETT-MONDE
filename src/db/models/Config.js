...
const configSchema = new Schema({
  ...
  boostRoleId:              { type: String, default: null }, // rôle attribué aux boosters
  ...
  dailyBonusRoleId:         { type: String, default: null }, // rôle bonus 24h si 3/3 missions
  // Rôles ping auto-assignables (boutons dans un salon)
  pingRolesChannelId:       { type: String, default: null },
  pingRolesMessageId:       { type: String, default: null },
  // ── Rôles ping (jamais @everyone) ─────────────────────────────────────────
  announceRoleId:           { type: String, default: null }, // ping annonces générales
  boostPingRoleId:          { type: String, default: null }, // ping boost
  youtubeRoleId:            { type: String, default: null }, // ping nouvelle vidéo
  twitchRoleId:             { type: String, default: null }, // ping live Twitch
